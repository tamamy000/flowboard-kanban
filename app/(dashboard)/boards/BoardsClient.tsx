    ...
    <>
      ...
      {boards.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-4 mt-24">
          <div className="w-16 h-16 rounded-2xl bg-column-bg flex items-center justify-center">
            <BoardIcon />
          </div>
          ...
          <button
            onClick={() => setShowModal(true)}
            className="bg-primary text-white text-base font-medium leading-6 tracking-[-0.31px] rounded-[10px] h-11 px-5 hover:bg-primary-hover transition-colors"
          >
            New Board
          </button>
        </div>
...
function BoardIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
      ...
      <rect x="15" y="3" width="10" height="10" rx="2" fill="#717182" opacity="0.4" />
      <rect x="3" y="15" width="10" height="10" rx="2" fill="#717182" opacity="0.4" />
      <rect x="15" y="15" width="10" height="10" rx="2" fill="#717182" opacity="0.2" />
    </svg>
  );
}
